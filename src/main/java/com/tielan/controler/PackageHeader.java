...
public class PackageHeader {
    ...
    public PackageHeader(short funcCode, int bodyLength){
    ...
    public byte[] encode(){    //编码
        ...
        for (int i = 0; i < b.length; i++) {
            b[i] = new Integer(tem1 & 0xff).byteValue();// 将最低位保存在最低位
            tem1 = tem1 >> 8;// 向右移8位
        }
        ...
        {
            b2[i] = new Integer(tem2 & 0xff).byteValue();// 将最低位保存在最低位
            tem2 = tem2 >> 8;// 向右移8位
        }
        ...
        {
            b3[i] = new Integer(tem3 & 0xff).byteValue();// 将最低位保存在最低位
            tem3 = tem3 >> 8;// 向右移8位
        }
        ...
        {
            a1[i] = new Integer(tem4 & 0xff).byteValue();
            tem4 = tem4 >> 8;
        }
        ...
        for (int i = 0; i < a2.length; i++) {
            a2[i] = new Integer(tem5 & 0xff).byteValue();
            tem5 = tem5 >> 8;
        }
 ...
 public static PackageHeader decode(byte[] bytes){  //解码
